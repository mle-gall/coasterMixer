...
CLASSES = (
    ...
    COASTERMIXER_OT_remove_train_camera,
    COASTERMIXER_OT_add_wheel_spin_binding,
    COASTERMIXER_OT_duplicate_wheel_spin_binding,
    COASTERMIXER_OT_remove_wheel_spin_binding,
    COASTERMIXER_OT_create_wheelcarrier_helpers,
    COASTERMIXER_OT_toggle_wheelcarrier_helpers,
